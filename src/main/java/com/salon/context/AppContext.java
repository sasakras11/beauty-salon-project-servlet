...
public class AppContext {
    ...
    private static final UserService USER_SERVICE = new UserServiceImpl(USER_DAO, CREDENTIALS_VALIDATOR,PASSWORD_UTIL);
    private static final SalonService SALON_SERVICE = new SalonServiceImpl(SALON_DAO,USER_DAO,DATA_PARSER);
    private static final ProcedureService PROCEDURE_SERVICE = new ProcedureServiceImpl(PROCEDURE_DAO,DATA_PARSER) ;
